...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-4-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-5-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-5-2.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-5-3.png)

a 代表某个用户的embedding向量，图中的散点代表物品的embedding向量。要找到与 a 最近邻的向量（最近邻在矩阵补充中就是向量内积最大）。

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-5-4.png)

将图中的散点划分为若干区域，每一个区域用一个向量来代替。也就是用一个区域向量来代替所在区域内的若干物品向量。

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-5-5.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-1.png)

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-2.png)

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-3.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-4.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-5.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-6-6.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-7-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-7-2.png)

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-7-3.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-7-4.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-8-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-8-2.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-9-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-9-2.png)

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-9-3.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-9-4.png)
...
1. 索引：
   - 路径 $\rightarrow$ Listlt;物品&gt;
   - 物品 $\rightarrow$ Listlt;路径&gt;
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-1.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-2.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-3.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-4.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-5.png)

根据神经网络对 L1 层的 k 个节点打的分选出四个分数最高的节点。

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-6.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-7.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-10-8.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-12-1.png)

![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-12-2.png)
...
![](./wangshusen_recommend_note/wangshusen_recommend_note_retrieval.assets/2-12-3.png)
